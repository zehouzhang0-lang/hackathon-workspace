...
用户睡前授权先整理第二、第三页的功能与交互问题，供明早逐项回应。入口见[明早讨论清单](docs/MORNING_REVIEW.md)；其中的默认建议尚未获批，不代表开始设计或写页面。
...
- [明早讨论清单](docs/MORNING_REVIEW.md)：后两页的阅读入口、待回应决定与跨页测试建议。
- [项目进度](PROGRESS.md)：记录当前阶段、已完成事项、待办和重要决定。
- [第一页已确认交互](docs/PAGE_ONE_SPEC.md)：低负担入口、同页整理、纠错与问题确认；视觉和技术细节待定。
- [第二页讨论稿](docs/PAGE_TWO_DISCUSSION.md)与[第三页讨论稿](docs/PAGE_THREE_DISCUSSION.md)：每页的目标、主流程、模拟走读和四项待确认决定。
